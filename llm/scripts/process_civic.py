...
def clean_mutation_pattern(input_string):
    try:
        ...
        logger.error(f"Error in clean_mutation_pattern: {e}")
        return input_string
...
def clean_variant(variant):
    ...
    Returns:
        - str: Cleaned and standarized variant name.
    """
    try:
        ...
        logger.error(f"Error in clean_variant: {e}")
        return variant
...
def get_civic_genes(civic):
    try:
        ...
        logger.error(f"KeyError in get_civic_genes: {e}")
        return []
...
def get_genes_synonym(gene_symbols: List[str], output_file):
    ...
    with DatasetsApiClient() as api_client:
        ...
        try:
            ...
            logger.error(f"Exception when calling GeneApi: {e}\n")
...
def expand_variant_aliases(variants_df, output_file):
    ...
    try:
        ...
        logger.error(f"KeyError in expand_variant_aliases: {e}")
    except Exception as e:
        logger.error(f"Error in expand_variant_aliases: {e}")
...
def process_civic_data(civic, output_file):
    try:
        ...
        logger.error(f"KeyError in process_civic_data: {e}")
    except Exception as e:
        logger.error(f"Error in process_civic_data: {e}")
